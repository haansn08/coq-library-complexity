From Undecidability.Shared.Libs.PSL Require Import FiniteTypes.BasicDefinitions.
From Complexity.Libs.PSL.Lists Require Import Dupfree.
From Complexity.Libs.PSL.FiniteTypes Require Import FinTypes.
...
Proof.
  ...
  - constructor.
  - intro H. constructor.
    + cbn in H.  specialize (H a). deq a. assert (count A a = 0) by lia. now apply notInZero.
